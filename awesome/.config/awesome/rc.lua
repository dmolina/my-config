...
browser    = "ck"
gui_editor = "emacs"
print_config = "system-config-printer"
graphics   = "gimp"
...
-- {{{ Tags
tags = {
   names = { "web", "term", "emacs", "media", "files", "other" },
   layout = { layouts[2], layouts[2], layouts[2], layouts[1], layouts[7], layouts[1] }
}
...
myweather = lain.widgets.weather({
    city_id = 2517117, -- Granada
--    city_id = 2520600, -- Cádiz, placeholder from http://openweathermap.org/city/2520600
    settings = function()
...
--        end),
    ...
    awful.key({ modkey }, "m", function () awful.util.spawn(monitor) end),
    awful.key({ modkey }, "e", function () awful.util.spawn(gui_editor) end),
    -- awful.key({ modkey }, "p", function () awful.util.spawn(print_config) end),
    awful.key({ }, "Print", function () awful.util.spawn(print_config) end),
...
awful.rules.rules = {
    ...
    { rule = { class = "URxvt", "Terminator" },
          properties = { opacity = 0.99 } },

    { rule = { class = "MPlayer", class = "Mpv" },
      properties = { floating = true } },
    { rule = { class = "Soffice", class = "soffice" },
      properties = { floating = true,
