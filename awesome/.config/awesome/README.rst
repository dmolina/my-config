...
-------------------------
Last customs from Awesome
-------------------------

:Author: Daniel Molina <danimolina [at] gmail [dt] com>
:Version: git
:License: BY-NC-SA_
...
- Run different applications in a specific tags:
  web (Web) term (Emacs) mail (Thunderbird) files
- Run Conkeror (ck) pessing C-i.

- Add udiskie to automatically mount directories.
- Launch nm-applet con connect wifi links).

Shortcuts
---------

Additional to shortcuts from the Theme, it includes the following ones:

:Shift-F1, Shirt F2: Change the focus between Screen 1 and 2.
:M-Up: Focus next application.
:M-Down: Focus previous application.
:M-Left: Change the tags to left.	 
:M-Right: Change the tags to right.	 
